...
function QuizCard({ quiz, attempt }) { // Tambahkan prop 'attempt'
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 m-4 w-full md:w-1/2 lg:w-1/3 hover:shadow-xl transition-shadow ease-in duration-200 flex flex-col justify-between">
      <div>
